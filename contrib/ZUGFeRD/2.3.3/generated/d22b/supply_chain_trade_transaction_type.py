...
class SupplyChainTradeTransactionType:
    ...
    :ivar included_supply_chain_trade_line_item: Included Trade Line
        Item
    :ivar applicable_header_trade_agreement: Header Trade Agreement
    :ivar applicable_header_trade_delivery: Header Trade Delivery
    :ivar applicable_header_trade_settlement: Header Trade Settlement
    """
